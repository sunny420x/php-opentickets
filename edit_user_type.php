...
if(isset($_GET['id'])) {
    $get_type = mysqli_prepare($db, "SELECT * FROM users_type WHERE type = ?");
...
<html>
    <head>
        <title>User Type Manager | PHP-OpenTickets</title>
    ...
    <body>
        <div class="admin-container">
            ...
            if(isset($_POST['edit_type'])) {
                ...
                $sql = mysqli_prepare($db, "UPDATE users_type SET type = ?, name = ? WHERE id = ?");
            ...
            <div class="container white pb-50">
                <h1 class="bb-blue"><i class="fa-solid fa-user mr-10"></i>User Type Manager.</h1>
